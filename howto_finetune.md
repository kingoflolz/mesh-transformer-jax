...
Also: the lr is set to end_lr after warmup_steps+anneal_steps and then keeps training until total_steps (well, it should, apparantly there's a bug that it might not stop at total_steps?)
